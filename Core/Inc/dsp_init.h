...
#ifndef INC_DSP_INIT_H_
#define INC_DSP_INIT_H_
 ...
 const uint8_t DSP_INIT[] =
{
  ...
  0x01, INIT_FLAG_PATCH1,                 // Load Required Initialization(s)....// Beginning of DSP_INIT bytes
  ...
  0x01, INIT_FLAG_PATCH2,                                           // Load Required Initialization(s)....//Beginning of LutByteValues
  ...
  0x02, INIT_FLAG_TIMER, 50,                                        // Wait 50 ms
 ...
 const uint8_t INIT_SET1[] =
{
  ...
  0x09, 0x20, 0x49, 0x01, 0x00, 0x01, 0x00, 0x50, 0x00, 0xA0,                                                  // FM 73 Set_StHiBlend_Noise        (1, 1, 80, 160)
  ...
  0x0B, 0x20, 0x5C, 0x01, 0x00, 0xFA, 0x00, 0xFA, 0x00, 0xFA, 0x00, 0xFA,
 ...
 const uint8_t INIT_SET3[] =
{
  ...
  0x09, 0x20, 0x2B, 0x01, 0x00, 0x03, 0x00, 0x64, 0x03, 0xE8,                                                  // FM 43 Set_Softmute_Noise         (1, 3, 100, 1000)
  0x09, 0x20, 0x2C, 0x01, 0x00, 0x03, 0x00, 0x64, 0x03, 0xE8,                                                  // FM 44 Set_Softmute_Mph           (1, 3, 100, 1000)
  ...
  0x09, 0x20, 0x35, 0x01, 0x00, 0x03, 0x00, 0xFA, 0x00, 0xC8,                                                  // FM 53 Set_Highcut_Noise          (1, 3, 250, 200)
  0x09, 0x20, 0x36, 0x01, 0x00, 0x03, 0x00, 0xFA, 0x00, 0xC8,                                                  // FM 54 Set_HighCut_Mph            (1, 3, 250, 200)
  0x07, 0x20, 0x37, 0x01, 0x00, 0x01, 0x09, 0x60,                                                              // FM 55 Set_HighCut_Max            (1, 1, 2400)
  0x07, 0x20, 0x38, 0x01, 0x00, 0x01, 0x3A, 0x98,                                                              // FM 56 Set_Highcut_Min            (1, 1, 15000)
  0x07, 0x20, 0x39, 0x01, 0x00, 0x01, 0x00, 0x78,                                                              // FM 57 Set_Lowcut_Max             (1, 1, 120)
  0x07, 0x20, 0x3A, 0x01, 0x00, 0x01, 0x00, 0x14,                                                              // FM 58 Set_Lowcut_Min             (1, 1, 20)
  ...
  0x0B, 0x20, 0x3D, 0x01, 0x00, 0x01, 0x01, 0xA4, 0x01, 0x40, 0x03, 0xE8,                                      // FM 61 Set_Stereo_Mod             (1, 1, 420, 320, 1000)
  0x09, 0x20, 0x3E, 0x01, 0x00, 0x01, 0x01, 0xCC, 0x00, 0xF0,                                                  // FM 62 Set_Stereo_Level           (1, 1, 460, 240)
  0x09, 0x20, 0x3F, 0x01, 0x00, 0x03, 0x02, 0x58, 0x00, 0xB4,                                                  // FM 63 Set_Stereo_Noise           (1, 3, 600, 180)
  0x09, 0x20, 0x40, 0x01, 0x00, 0x03, 0x02, 0x58, 0x00, 0xDC,                                                  // FM 64 Set_Stereo_Mph             (1, 3, 600, 220)
  0x05, 0x20, 0x41, 0x01, 0x00, 0x01,                                                                          // FM 65 Set_Stereo_Max             (1, 1)
  ...
  const uint8_t INIT_SET4[] =
{
 ...
 uint8_t AMFilterMap[] = { 30, 40, 60, 80, 30, 40, 60, 80, 30, 40, 60, 80, 30, 40, 60, 80 };
 uint16_t FMFilterMap[] = { 560, 640, 720, 840, 970, 1140, 1330, 1510, 1680, 1840, 2000, 2170, 2360, 2540, 2870, 3110 };




#endif /* INC_DSP_INIT_H_ */
