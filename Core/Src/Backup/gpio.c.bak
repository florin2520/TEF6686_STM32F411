...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, VFD_CS_Pin|HCMS_RS_Pin|HCMS_BLANK_Pin|HCMS_RESET_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : HCMS_CE_LED_Pin */
  GPIO_InitStruct.Pin = HCMS_CE_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(HCMS_CE_LED_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : FREQ_SEEK_UP_Pin FREQ_SEEK_DOWN_Pin */
